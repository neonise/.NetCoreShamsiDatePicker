...
namespace RMDP.Localization
{
    /// <summary>
    /// Localizer class to work with public localized strings.
    /// </summary>
    public class FALocalizeManager
    {
        ...
        /// </summary>
        public BaseLocalizer GetLocalizerByCulture(CultureInfo ci)
        {
