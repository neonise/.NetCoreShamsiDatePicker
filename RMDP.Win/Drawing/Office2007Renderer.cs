...
namespace RMDP.Win.Drawing
{
    ...
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private static float _cutMenuItemBack = 0f;
        //private static float _cutRoundButtons = 1.2f;
        ...
        // Color scheme values
        internal static Color _textDisabled = _c1;
        internal static Color _textMenuStripItem = _c2;
        internal static Color _textStatusStripItem = _c2;
        internal static Color _textContextMenuItem = _c2;
        internal static Color _arrowDisabled = _c1;
        internal static Color _arrowLight = Color.FromArgb(106, 126, 197);
        internal static Color _arrowDark = Color.FromArgb(64, 70, 90);
        internal static Color _separatorMenuLight = Color.FromArgb(245, 245, 245);
        internal static Color _separatorMenuDark = Color.FromArgb(197, 197, 197);
        internal static Color _contextMenuBack = _c4;
        internal static Color _contextCheckBorder = Color.FromArgb(242, 149, 54);
        internal static Color _contextCheckTick = Color.FromArgb(66, 75, 138);
        internal static Color _statusStripBorderDark = Color.FromArgb(86, 125, 176);
        internal static Color _statusStripBorderLight = Color.White;
        internal static Color _gripDark = Color.FromArgb(114, 152, 204);
        internal static Color _gripLight = _c5;
        internal static GradientItemColors _itemContextItemEnabledColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, Color.FromArgb(217, 203, 150), Color.FromArgb(192, 167, 118));
        internal static GradientItemColors _itemDisabledColors = new GradientItemColors(_c4, _c6, Color.FromArgb(236, 236, 236), Color.FromArgb(230, 230, 230), _c6, Color.FromArgb(224, 224, 224), Color.FromArgb(200, 200, 200), Color.FromArgb(210, 210, 210), Color.FromArgb(212, 212, 212), Color.FromArgb(195, 195, 195));
        internal static GradientItemColors _itemToolItemSelectedColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, _r9, _rA);
        internal static GradientItemColors _itemToolItemPressedColors = new GradientItemColors(_rD, _rE, _rF, _rG, _rH, _rI, _rJ, _rK, _r9, _rA);
        internal static GradientItemColors _itemToolItemCheckedColors = new GradientItemColors(_rL, _rM, _rN, _rO, _rP, _rQ, _rR, _rS, _r9, _rA);
        internal static GradientItemColors _itemToolItemCheckPressColors = new GradientItemColors(_rT, _rU, _rV, _rW, _rX, _rI, _rY, _rZ, _r9, _rA);
        ...
        public void DrawGradientItem(Graphics g,
                                      Rectangle backRect,
                                      GradientItemColors colors)
        {
            // Cannot paint a zero sized area
        ...
        public void DrawGradientBorder(Graphics g,
                                        Rectangle backRect,
                                        GradientItemColors colors)
        {
            // Drawing with anti aliasing to create smoother appearance
